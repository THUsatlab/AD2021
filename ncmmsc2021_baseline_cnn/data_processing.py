...
# Loading the label map
    ...
    one_hot_y_test_melspec =one_hot_y_melspec
    one_hot_y_test_spec=one_hot_y_spec
    one_hot_y_test_mfcc=one_hot_y_mfcc

    np.save(SPLITS_FOLDER + 'X_train_melspec.npy', X_test_filenames_melspec)
    
    np.save(SPLITS_FOLDER + 'X_train_spec.npy', X_test_filenames_spec)

    np.save(SPLITS_FOLDER + 'X_train_mfcc.npy', X_test_filenames_mfcc)

    np.save(SPLITS_FOLDER + 'y_train_melspec.npy', one_hot_y_test_melspec)

    np.save(SPLITS_FOLDER + 'y_train_spec.npy', one_hot_y_test_spec)

    np.save(SPLITS_FOLDER + 'y_train_mfcc.npy', one_hot_y_test_mfcc)
