...
def make_dirs(path):
    if not os.path.exists(path+'testdata/'):
        os.makedirs(path+'testdata/')
    if not os.path.exists(path+'test/melspec/'):
        os.makedirs(path+'test/melspec/')
    if not os.path.exists(path+'test/spec/'):
        os.makedirs(path+'test/spec/')
    if not os.path.exists(path+'test/mfcc/'):
        os.makedirs(path+'test/mfcc/')
