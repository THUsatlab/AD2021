...
def create_dataset(audio_path, train_test, melspecs_folder=None, specs_folder=None, mfccs_folder=None,
...
if __name__ == '__main__':
    ...
    train_test = (args.train_test == 'train')
    ...
    create_dataset(audio_path, train_test,
